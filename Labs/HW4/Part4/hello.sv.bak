...
// of the reset states could be replaced to reduce code redundancy. 
...
// In this testbench I let the clock go for 110 time unites. This 
// allows me to see if the outputs are as desired. In the assignment
// instructions is was not specified how it was specified for us to
// test our circuit. Since there is no driving input nothing can be driven
// except for the clock to obtain the output you desire.
`timescale 1ns/1ns
